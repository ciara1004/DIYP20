...
import kotlinx.android.synthetic.main.content_specialities.orderButton
import kotlinx.android.synthetic.main.content_default_bar.toolbar
import org.jetbrains.anko.AnkoLogger
import org.jetbrains.anko.info
import org.jetbrains.anko.toast

class Specialities : AppCompatActivity(), AnkoLogger {
    lateinit var app: DIYPApp
    var order = DIYPModel()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.content_specialities)
